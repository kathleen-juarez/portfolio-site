...
<table class="skills-table">
  ...
  <tbody>
    <tr>
      <td>
        <div class="skill-item">Multi-channel campaign <br> planning &amp; execution</div>
        <div class="skill-item">Social media content management</div>
        <div class="skill-item">Email marketing</div>
        <div class="skill-item">Brand messaging</div>
        <div class="skill-item">Audience segmentation</div>
      </td>
      <td>
        <div class="skill-item"> CapCut (video editing)</div>
    ...
    <tr>
      ...
      <th style="background-color:#7aa496; color:#fff; text-transform:uppercase; letter-spacing:0.06em; font-size:0.88rem; padding:13px 18px;">Design</th>
    </tr>
    <tr>
      <td>
        <div class="skill-item">Audience engagement metrics &amp; conversion analysis</div>
        <div class="skill-item">Conversion &amp; performance analysis</div>
        <div class="skill-item">Marketing forecasting</div>
      ...
      <td>
      <div class="skill-item"> Adobe Creative Suite <br> (Photoshop, Illustrator, InDesign)</div>
...
### Communications Coordinator and Property Assistant,<br>The Ratkovich Company
...
### Editorial Intern,<br>Flaunt Magazine
...
### Summer Day Camp Director and Grant Writer,<br>YMCA of West San Gabriel Valley
