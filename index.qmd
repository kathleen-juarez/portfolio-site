...
<div class="hero-wrapper">
  ...
  <!--  <div class="hero-title">Marketer in Practice, Writer at Heart</div> -->
    <div class="hero-subtitle hero-subtitle--bottom">Creative. Analyst. Words that work. Proof they do.</div>
  </div>
</div>
```
...
<div id="siteModal" style="display:none; position:fixed; top:0; left:0; width:100%; 
  ...
  <div style="background:white; border-radius:16px; padding:2rem; max-width:500px; 
    ...
    <p>I don't do generic. Building it from scratch meant I could be deliberate about everything: the spacing, the tone, every pixel, every word. Every choice was intentional. For better or for worse, I pay attention to the details most people scroll past.</p>
